...
function preload() {
  backgroundImage = loadImage("data/wall.png");
  paizi = loadImage("data/paizi.png");
  mosquito = loadImage("data/11.png");
  //hjj = loadImage('HJJLOGOTOUMING.png');
  
//Load the sound
  //soundFormats("wav");
  ballClickSound = loadSound("data/hitsound.m4a");
  missClickSound = loadSound("data/misshitsound.m4a");
  gameoverSound = loadSound("data/Nicebro.m4a");
  gameoverSound1 = loadSound("data/Keepgoingbro.m4a");
  gameoverSound2 = loadSound("data/Damnyoudidagoogjob.m4a");
}
